...
export default function Home() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12 font-sans bg-gray-50 text-gray-900">
      ...
      {/* Premium Banner */}
<section className="mt-24 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-xl shadow-lg p-10 text-center">
  <h3 className="text-3xl font-bold mb-4">🚀 Upgrade auf Premium</h3>
  <p className="text-lg mb-6 max-w-2xl mx-auto">
    Erhalte unbegrenzte CSV-Analysen, bevorzugte Bearbeitung, schnelleren Support
    und Premium-Features. Hol das Maximum aus deinen Daten heraus.
  </p>
  <button className="bg-white text-blue-700 font-semibold px-8 py-3 rounded-full hover:bg-blue-100 transition duration-200">
